...
export class Backend implements backendInterface {
    ...
    async deleteSnapshot(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getSnapshots(): Promise<Array<Snapshot>> {
        if (this.processError) {
            try {
    ...
    async saveSnapshot(arg0: Snapshot): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSnapshot(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
